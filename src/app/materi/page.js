    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Content style={{ textAlign: 'justify' }}>
        ...
        >
          ...
          <h4>1. Masjid Luar Batang tempo dulu</h4>
          ...
          <h4 style={{ margin: '16px 0 16px 0' }}>2. Masjid Luar Batang di Era Modern</h4>
          ...
          <h3 style={{ margin: '16px 0 16px 0' }}>E. Uji Kompetensi</h3>
          ...
          <h3 style={{ margin: '16px 0 16px 0' }}>F. Penilaian Diri</h3>
